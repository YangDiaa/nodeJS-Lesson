...
http.createServer(function(req,res){
    ...
    switch(pathName){
        ...
        default:
            ...
            if(ext == ".css"|| ext ==".js" || ext =='.jpg' || ext ==".png" || ext == ".jpeg"){
...
function addContent(req,res){
    ...
    req.on("end",function(){
        var chapter = {};
        var dataObj = querystring.parse(dataStr);
        chapter.chapterName = dataObj.title;
        chapter.chapterContent = dataObj.content; 
        chapter.chapterId = chapterList.length + 1;
